...
latex_documents = [
    (master_doc, 'WorkiceDocs.tex', u'CRM Documentation',
...
man_pages = [
    (master_doc, 'crmdocs', u'CRM Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'CRM', u'CRM Documentation',
     author, 'CRM', 'One CRM to manage your entire invoicing, expenses, deals and projects',
     'Miscellaneous'),
]
